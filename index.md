...
| 1:00 PM - 1:20 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 05:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 05:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Lei Chen, "Vertex-primitive s-arc-transitive digraphs of almost simple groups" |  **---** |
...
| 2:00 PM - 2:20 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 06:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 06:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Murray Elder, "The isomorphism problem for plain groups is in $\Sigma_3^{\mathsf{P}}$" | Pankaj Kumar Manjhi, "Mutually Orthogonal Latin squares and Frobenius Group" |
| 2:30 PM - 2:50 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 06:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 06:50:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | John Cu, "Experimenting with rewriting systems" | Stephen Glasby, "On the maximum of the weighted binomial sum $2^{-r}\sum_{i=0}^r\binom{m}{i}$" |
| 3:00 PM - 3:20 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 07:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 07:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) |  Edmund Heng, "Generalised braid groups, categorification and dynamics" | Mihai-Silviu Lazorec, "On the average order of a finite group" |
...
| 2:00 PM - 2:20 PM <br/> ( locally <script> var date = new Date('Thur, 18 Nov 2021 06:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Thur, 18 Nov 2021 06:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Kevin Limanta, "Super Catalan Numbers and Fourier Summation over Finite Fields" |  Jesse Lansdown, "There are no block-transitive subspace designs" |
...
| 3:00 PM - 3:20 PM <br/> ( locally <script> var date = new Date('Thur, 18 Nov 2021 07:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Thur, 18 Nov 2021 07:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Darryl Teo, "On the Intersection Multiplicity of Plane Curves" | Richard Garner, "The variety of cartesian closed varieties" |
...
| 1:30 PM - 1:50 PM <br/> ( locally <script> var date = new Date('Fri, 19 Nov 2021 05:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Fri, 19 Nov 2021 05:50:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Youming Qiao, "Some new connections between groups and graphs" |  James East, "Ehresmann theory and partition monoids" |
| 2:00 PM - 2:20 PM <br/> ( locally <script> var date = new Date('Fri, 19 Nov 2021 06:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Fri, 19 Nov 2021 06:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Santiago Barrera Acevedo, "Cocyclic Two Circulant Core Hadamard Matrices" | Andrew Craig, "Dual digraphs of finite semidistributive lattices" |
| 2:30 PM - 2:50 PM <br/> ( locally <script> var date = new Date('Fri, 19 Nov 2021 06:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Fri, 19 Nov 2021 06:50:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) |  | Marcel Jackson, "On kernels of relations" |
