...
| 12:00 PM - 12:20 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 04:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 04:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Ian Wanless, <br/> "Maximally nonassociative quasigroups" ([recording](https://youtu.be/Q05mcBzphWI)) |  **---** |
| 12:30 PM - 12:50 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 04:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 04:50:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Jack Allsop, <br/> "Solution to a question of Falconer on quasigroup varieties" ([recording](https://youtu.be/X0FrGnQh-18)) |  **---** |
| 1:00 PM - 1:20 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 05:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 05:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Lei Chen, <br/> "Vertex-primitive s-arc-transitive digraphs of almost simple groups" ([recording](https://youtu.be/V3LNqG8yhdo)) |  **---** |
| 1:30 PM - 2:00 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 05:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 06:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | **break** | **break**  |
| 2:00 PM - 2:20 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 06:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 06:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Murray Elder, <br/> "The isomorphism problem for plain groups is in $\Sigma_3^{\mathsf{P}}$" ([recording](https://youtu.be/8WwTY_DszdI))| Pankaj Kumar Manjhi, <br/> "Mutually Orthogonal Latin squares and Frobenius Group" ([recording](https://youtu.be/KcpURcUzmzc))|
| 2:30 PM - 2:50 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 06:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 06:50:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | John Cu, <br/> "Experimenting with rewriting systems" ([recording](https://youtu.be/JHlwolxCo8s)) | Stephen Glasby,  <br/>"On the maximum of the weighted binomial sum $2^{-r}\sum_{i=0}^r\binom{m}{i}$" |
| 3:00 PM - 3:20 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 07:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 07:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) |  Edmund Heng, <br/> "Generalised braid groups, categorification and dynamics" ([recording](https://youtu.be/1RB2BeLzIME)) | Mihai-Silviu Lazorec, <br/> "On the average order of a finite group" ([recording](https://youtu.be/i6uEFDCWs9k)) |
| 3:30 PM - 4:00 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 07:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 08:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | **break** | **break** |
| 4:00 PM - 4:45 PM <br/> ( locally <script> var date = new Date('Wed, 17 Nov 2021 08:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 08:45:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | **Alejandra Garrido, <br/> "Simple groups of homeomorphisms of Cantor space"** ([recording](https://youtu.be/5MafD30ad-Q))| **---** |

#### Thursday 18th

| Time | Stream A | Stream B | 
|:--|:--|:--|
| 12:00 PM - 12:20 PM <br/> ( locally <script> var date = new Date('Thur, 18 Nov 2021 04:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Thur, 18 Nov 2021 04:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Roozbeh Hazrat, <br/> "Irreducible representations of Leavitt algebras" ([recording](https://youtu.be/i2PshZKNsx0))| **---** |
| 12:30 PM - 12:50 PM <br/> ( locally <script> var date = new Date('Thur, 18 Nov 2021 04:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Thur, 18 Nov 2021 04:50:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Ivo Vekemans, <br/> "Mackey and Tambara functors as $G$-commutative monoids" ([recording](https://youtu.be/aGDWKuKqhtM))| **---** |
| 1:00 PM - 1:20 PM <br/> ( locally <script> var date = new Date('Thur, 18 Nov 2021 05:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Thur, 18 Nov 2021 05:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Kane Townsend, <br/> "Levi subgroups minimally containing Sylow subgroups" ([recording](https://youtu.be/dgypBRJtS1c)) | **---** |
| 1:30 PM - 2:00 PM <br/> ( locally <script> var date = new Date('Thur, 18 Nov 2021 05:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Thur, 18 Nov 2021 06:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | **break** | **break**  |
| 2:00 PM - 2:20 PM <br/> ( locally <script> var date = new Date('Thur, 18 Nov 2021 06:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Thur, 18 Nov 2021 06:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Kevin Limanta, <br/> "Super Catalan Numbers and Fourier Summation over Finite Fields" ([recording](https://youtu.be/BF2zOP_Pmwk)) |  Jesse Lansdown, <br/> "There are no block-transitive subspace designs" ([recording](https://youtu.be/fjSiAOm8lCI)) |
| 2:30 PM - 2:50 PM <br/> ( locally <script> var date = new Date('Thur, 18 Nov 2021 06:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Thur, 18 Nov 2021 06:50:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Su Yuan Chan, <br/> "Bounds on the Inducibility of Double Loop Graphs" ([recording](https://youtu.be/wRnWLPdv6W0)) | Heiko Dietrich, <br/> "Galois trees for $p$-groups of maximal class" ([recording](https://youtu.be/0CzQTeQwrKM))|
| 3:00 PM - 3:20 PM <br/> ( locally <script> var date = new Date('Thur, 18 Nov 2021 07:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Thur, 18 Nov 2021 07:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Darryl Teo,<br/> "On the Intersection Multiplicity of Plane Curves" ([recording](https://youtu.be/_XQLmUvqvMw)) | Richard Garner, <br/> "The variety of cartesian closed varieties" ([recording](https://youtu.be/sMCCsrmETbk)) |
| 3:30 PM - 4:00 PM <br/> ( locally <script> var date = new Date('Thur, 18 Nov 2021 07:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Thur, 18 Nov 2021 08:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | **break** | **break** |
| 4:00 PM - 4:45 PM <br/> ( locally <script> var date = new Date('Thur, 18 Nov 2021 08:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Thur, 18 Nov 2021 08:45:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | **Eugenio Giannelli, <br/> "On Sylow Branching Coefficients"** ([recording](https://youtu.be/67ygBqnyaj4)) | **---** |
...
| Time | Stream A | Stream B | 
|:--|:--|:--|
| 12:00 PM - 12:45 PM <br/> ( locally <script> var date = new Date('Fri, 19 Nov 2021 04:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Fri, 19 Nov 2021 04:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | **Melissa Lee, <br/> "An algebraic tasting platter"** ([recording](https://youtu.be/z_ijA1mFqOg))  | **---** |
| 1:00 PM - 1:10 PM <br/> ( locally <script> var date = new Date('Fri, 19 Nov 2021 05:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Fri, 19 Nov 2021 05:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | **Presentation of Gordon Preston Prize <br/> & <br/> Conference "photo"** | **---** |
...
| 1:30 PM - 1:50 PM <br/> ( locally <script> var date = new Date('Fri, 19 Nov 2021 05:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Fri, 19 Nov 2021 05:50:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Youming Qiao, <br/> "Some new connections between groups and graphs" ([recording](https://youtu.be/gT_W5QFQzlQ))|  James East, <br/> "Ehresmann theory and partition monoids" ([recording](https://youtu.be/pEzTUbPAZAo)) |
| 2:00 PM - 2:20 PM <br/> ( locally <script> var date = new Date('Fri, 19 Nov 2021 06:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Fri, 19 Nov 2021 06:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Santiago Barrera Acevedo, <br/> "Cocyclic Two Circulant Core Hadamard Matrices" ([recording](https://youtu.be/f9OrqSoaEpw)) | Andrew Craig, <br/> "Dual digraphs of finite semidistributive lattices" ([recording](https://youtu.be/o4gmY9N94Pk)) |
| 2:30 PM - 2:50 PM <br/> ( locally <script> var date = new Date('Fri, 19 Nov 2021 06:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Fri, 19 Nov 2021 06:50:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | **---** | Marcel Jackson, <br/> "On kernels of relations" ([recording](https://youtu.be/Ff1S0_--lZE))|
...
{:refdef: style="text-align: center;"}
![Conference Photo](/ConferencePhoto.png)
{: refdef}
