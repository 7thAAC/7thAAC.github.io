...
| 1:30 PM - 1:50 PM <br/> ( locally <script> var date = new Date('Fri, 19 Nov 2021 05:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Fri, 19 Nov 2021 05:50:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Youming Qiao, <br/> "Some new connections between groups and graphs" |  James East, <br/> "Ehresmann theory and partition monoids" ([recording](https://youtu.be/pEzTUbPAZAo)) |
| 2:00 PM - 2:20 PM <br/> ( locally <script> var date = new Date('Fri, 19 Nov 2021 06:00:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Fri, 19 Nov 2021 06:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | Santiago Barrera Acevedo, <br/> "Cocyclic Two Circulant Core Hadamard Matrices" ([recording](https://youtu.be/4t45lrqXwx4)) | Andrew Craig, <br/> "Dual digraphs of finite semidistributive lattices" ([recording](https://youtu.be/o4gmY9N94Pk)) |
