...
| 1:30 PM - 2:00 PM ( locally <script> var date = new Date('Wed, 17 Nov 2021 05:30:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> to <script> var date = new Date('Wed, 17 Nov 2021 06:20:00 GMT');document.write(date.toLocaleTimeString(navigator.language, {hour: '2-digit', minute:'2-digit'}));</script> ) | **break** | **break**  |
